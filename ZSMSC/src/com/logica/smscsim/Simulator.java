...
public class Simulator
{
     ...
     */
    static String usersFileName = "config.ini";
    ...
    protected void menu() throws IOException
    {
        ...
        //read config file and put it to target variable
        ConfReader conf = new ConfReader(Simulator.usersFileName);
        if(conf.getSpoolMODir() != null) {
            this.spoolMODir = conf.getSpoolMODir();
        }
        if(conf.getSpoolMTDir() != null) {
            this.spoolMTDir = conf.getSpoolMTDir();
        }
